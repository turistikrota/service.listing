...
type PostValidatedCommand struct {
...
type PostValidatedHandler cqrs.HandlerFunc[PostValidatedCommand, *PostValidatedRes]

func NewPostValidatedHandler(factory post.Factory, repo post.Repository, events post.Events) PostValidatedHandler {
	return func(ctx context.Context, cmd PostValidatedCommand) (*PostValidatedRes, *i18np.Error) {
